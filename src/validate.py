...
def get_plots(data, methods, alphas_calib, alphas_valid, file_path):
    ...
    conformal_bound2 = x + 1 / ((len(data) // 2) + 1)  # Shifted bound
...
if __name__ == "__main__":
    ...
    get_plots(questions, methods, calib_alphas, valid_alphas, "/Users/maxonrubin-toles/Desktop/Conformal/Open_Source/out")
